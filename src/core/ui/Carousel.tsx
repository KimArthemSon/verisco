...
export function Carousel({ slides, height = 210 }: { slides: Slide[]; height?: number }) {
    ...
    <View>
      ...
      >
        {slides.map((s, i) => (
          <View
            key={i}
            style={[styles.slide, { width, height, backgroundColor: colors.surface }]}
          >
            <Image source={s.image} style={styles.img} resizeMode="cover" />
            <LinearGradient
